...
const WORKSHEETS = {
  development: [
    { id:'idea', label:'Your main idea (write or draw description)', type:'textarea', required:true },
    { id:'characters', label:'Describe your main character(s)', type:'textarea', required:false },
    { id:'outline', label:'Story outline (Beginning / Middle / End)', type:'textarea', required:true },
    { id:'q1', label:'What is your film idea about?', type:'textarea', required:true },
    { id:'q2', label:'What do you like most about your idea?', type:'textarea', required:true },
    { id:'q3', label:'Who will enjoy watching your film?', type:'textarea', required:true }
  ],
  preproduction: [
    ...
    { id:'preRole', label:'What is your role in the team?', type:'textarea', required:true },
    { id:'preHelp', label:'How did you help plan the film?', type:'textarea', required:true },
    { id:'preFirst', label:'What will you do first when filming starts?', type:'textarea', required:true }
  ],
  production: [
    { id:'setupNotes', label:'Camera / tripod setup notes (safety, location, etc.)', type:'textarea', required:true },
    { id:'sceneLog', label:'Filming log (which scenes did you record?)', type:'textarea', required:true },
    { id:'soundCheck', label:'Sound check notes (volume / background noise)', type:'textarea', required:false },
    { id:'teamworkNotes', label:'Teamwork notes (who helped, what went well as a crew?)', type:'textarea', required:false },
    { id:'prodJob', label:'What was your job during filming?', type:'textarea', required:true },
    { id:'prodGood', label:'What went well while filming?', type:'textarea', required:true },
    { id:'prodImprove', label:'What could your team improve next time?', type:'textarea', required:true }
  ],
  postproduction: [
    { id:'editNotes', label:'Editing notes (what did you cut / change?)', type:'textarea', required:true },
    { id:'musicTitles', label:'Music / titles / transitions added', type:'textarea', required:false },
    { id:'postLearn', label:'What did you learn about editing?', type:'textarea', required:true },
    { id:'postFav', label:'What is your favourite part of your finished film?', type:'textarea', required:true },
    { id:'postChange', label:'If you could change one thing, what would it be?', type:'textarea', required:true }
  ]
};
...
async function openWorksheet(stage){
  ...
  const objMap={
    ...
    preproduction:[
      'Plan scenes, roles, and resources needed for filming.',
      'Learn about storyboards, shot lists, and scripts.'
    ],
    production:[
      'Follow a plan to record scenes.',
      'Operate camera, sound, and lighting safely.',
  ...
  const taskMap={
    development:[
      ...
      'Write or draw your story outline (beginning, middle, end).',
      'Share your idea with your group or teacher.'
    ],
    preproduction:[
      'Decide who will be in your team (director, camera, actor, sound).',
      'Draw your storyboard (show what happens in each scene).',
      'Make a list of props and equipment you will need.',
      'Write a short script or notes for your actors.',
      'Check that your camera and tripod are ready to use.'
    ],
    production:[
      'Set up your camera and tripod safely.',
      'Film each scene following your storyboard.',
      'Check sound levels before recording.',
      'Work as a team – help each other.',
      'Review your footage after each session.'
    ],
    postproduction:[
      'Import your footage into the editing software (e.g. iMovie or Clipchamp).',
      'Cut out parts you don’t need.',
      'Add music, titles, and transitions.',
      'Watch your edited film and share feedback with your team.',
      'Write your final reflection below.'
    ]
  };
